class LittersController < ApplicationController
  ...
  def new   
    ...
    redirect_to root_path, notice: 'To add a new litter please navigate to Our dogs, the mother you wish to add a new litter for and use the new litter feature.'
    end
  end
  ...
  private
    ...
    def set_litter
      @litter = Litter.friendly.find(params[:id])
    end

    # Never trust parameters from the scary internet, only allow the white list through.
    def litter_params
      params.require(:litter).permit(:date, :about, :main_image, :image_one, :image_two, :mother_id)
    end
end
